				...
				<div class="content border">				
					...
					<div class="desk inline-right">
						...
						<?php while ($number != 0):?>						
							<div class="font-tnr">
								<?php if ($number == 1): ?>
									<a href="/?page=comment" class="page-link msg-pagenumber inline-right border-solid"><?php echo $number;?></a>
								<?php else:?>
									<a href="/?page=comment&num=<?php echo $number;?>" class="page-link msg-pagenumber inline-right border-solid"><?php echo $number;?></a>
								<?php endif;?>
							</div>
							<?php $number--;?>
						<?php endwhile;?>
					...
					<div class="form">
						<form id="main-form" method="POST">
							...
							<input type="text" id="mail" placeholder="Укажите свой e-mail" name="e-mail" class="font-vernara font-black">
