...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 22 2014 г., 14:05
...
(1, 'Арекаев Алексей Юрьевич', 'Почти 25 лет, холост, детей не имею. Имею интерес к областям электроники и вычислительной техники.', 'В 2007 году окончил Парцинскую среднюю общеобразовательную школу, поступил в институт физки и химии ФГБОУ ВПО "МГУ им. Н.П.Огарева".\nОкончил в 2011 году бакалавриат по специализации "Физика твердого тела" тема квалификационной работы - "Применение методов компьютерного моделирования к процессу осаждения плёнок", поступил в магистратуру того же института.\nВ 2013 году защитил магстерскую диссертацию по теме "Исследование структурных превращений аморфных металлических сплавов при отжиге".Специализация "Физика конденсированного состояния вещества".\nВ августе того же года поступил в аспирантуру, откуда в последствии отчислился по собственному желанию.', '', '"ООО НПП ЦАРМ"', '01.2013-05.2014', 'Инженер испытательной лаборатории');
